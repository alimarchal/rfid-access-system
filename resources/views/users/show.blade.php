                    ...
                    <div class="p-6 sm:p-8">
                        <h3 class="text-xl font-bold text-white mb-6 flex items-center">
                            ...
                            <div class="mt-6 flex justify-right">
                                <a href="{{ route('family-members.rfid_card_create_via_user', $user->id) }}" <button
...
<div class="mb-6">
    <form action="{{ route('entries.store') }}" method="POST" class="space-y-4">
        ...
        @endif
            ...
            <!-- Vehicles Section -->
            <a href="{{ route('vehicles.vehicles_create_via_user', $user->id) }}" <div
                                            ...
                                            <div class="min-w-0 flex-1 pt-1.5 flex justify-between space-x-4">
                                                <div>
                                                    <p class="text-sm text-gray-500 dark:text-gray-400">
                                                        ...
                                                        <span
                                                            class="font-medium text-gray-900 dark:text-gray-100">{{ $entry->rfid_card->card_number }}</span>
                                                    </p>
                                                </div>
                                                <div
