                    ...
                    <form method="POST" action="{{ route('rfid-cards.update', $rfidCard) }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <x-input id="card_number" type="text" name="card_number" class="mt-1 block w-full"
                                    :value="old('card_number', $rfidCard->card_number)" required maxlength="20" />
                            </div>
                            ...
                            <div>
                                ...
                                <select id="status" name="status"
                                    ...
                                    required>
                                    <option value="active"
                                        {{ old('status', $rfidCard->status) == 'active' ? 'selected' : '' }}>
                                        Active
                                    </option>
                                    <option value="inactive"
                                        {{ old('status', $rfidCard->status) == 'inactive' ? 'selected' : '' }}>
                                        Inactive
                                    </option>
                                    <option value="expired"
                                        {{ old('status', $rfidCard->status) == 'expired' ? 'selected' : '' }}>
                                        Expired
                                    </option>
                                </select>
                            </div>
                            ...
                            <div>
                                ...
                                <x-input id="expiry_date" type="date" name="expiry_date" class="mt-1 block w-full"
                                    :value="old('expiry_date', $rfidCard->expiry_date->format('Y-m-d'))" required />
                            </div>
                        </div>
